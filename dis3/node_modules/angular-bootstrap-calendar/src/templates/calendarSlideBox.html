    ...
    <ul class="unstyled list-unstyled">
      ...
      <li
        ...
        <a
          ...
          <!-- This part below should be deleted as it is displaying the 24H start time only at the end of the event title, but this file does not seem to recompile when it is changed so it's still here for now for future reference -->
